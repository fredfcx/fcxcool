			...
			var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
				...
				r = function() {
					var t = {
						...
						i = void 0,
						r = void 0;
					if (S.container) if (S.container instanceof Object) i = (t = e({}, t, S.container)).width - t.left - t.right - 2 * S.margin, r = t.height - t.top - t.bottom - 2 * S.margin;
					else {
